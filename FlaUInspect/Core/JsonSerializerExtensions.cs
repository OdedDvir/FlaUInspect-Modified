        ...
        public static string SerializeObject(object obj, JsonSerializerSettings settings = null)
        {
            ...
            using (var jsonWriter = new JsonTextWriter(writer))
            {
                ...
                try
                {
                    ...
                    EventHandler<Newtonsoft.Json.Serialization.ErrorEventArgs> p = delegate (object sender, Newtonsoft.Json.Serialization.ErrorEventArgs args)
                                           {
                                               jsonWriter.Flush();
